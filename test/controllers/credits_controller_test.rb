...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { date_finish: @credit.date_finish, date_ini: @credit.date_ini, quotes: @credit.quotes } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { date_finish: @credit.date_finish, date_ini: @credit.date_ini, quotes: @credit.quotes } }
